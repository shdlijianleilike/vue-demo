...
/*var coverPlugin={
  install(Vue,option){
    Vue.prototype.cover=function(o){
      if(o.type=='close'){
        coverExp.isCovering=showCover=false;
        return;
      }
      if(showCover)return;
      let cover = Vue.extend({
        data(){
  ...
  install(Vue,options){
    Vue.prototype.loading=function(o){
      ...
      let Loading = Vue.extend({
        ...
        //template:'<div  v-if="isLoading" class="load-box"> <span class="spot1"></span> <span class="spot2"></span></div>',
        template:'<div  v-if="isLoading" class="load-box2"><div class="spinner"><div class="spinner-container container1"><div class="circle1"></div><div class="circle2"></div><div class="circle3"></div><div class="circle4"></div></div><div class="spinner-container container2"><div class="circle1"></div><div class="circle2"></div><div class="circle3"></div><div class="circle4"></div></div><div class="spinner-container container3" ><div class="circle1"></div><div class="circle2"></div><div class="circle3"></div><div class="circle4"></div></div></div><div class="load-content">'+tip+'</div></div>',
...
var ToastPlugin={
  install(Vue,options) {
    Vue.prototype.toast = function (o){
      var o=o||{};
      var tip=typeof o == 'string' ? o : o.tip;
      //是否已经显示
      ...
      cover();
      setTimeout(()=>{toastExp.isToast=showToast=false; toastArr.shift();closeCover();},o.time||2000)
    };
  }
     ...
     /* if(o.type=='close'){
      ...
      return new Promise(function(resolve,reject){
        let Confirm = Vue.extend({
          ...
          template:'<div v-if="isConfirming" class="confirm-box"><div class="content-box"><p>'+tip+'</p></div><div class="btn-box"><a class="cancel" @click="Cancel_fn">取消</a><a class="ok" @click="OK_fn">确定</a></div></div>',
          methods:{
            OK_fn(){
              closeCover();
              confirmExp.isConfirming=showConfirm=false;
